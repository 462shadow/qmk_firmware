...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_60_ansi(
        ...
        KC_LCTL,        KC_LGUI, KC_LALT,                            KC_SPC,                             KC_RALT, LGUI(KC_TAB), KC_RCTL,   MO(2)
    ),
    [1] = LAYOUT_60_ansi(
    ...
    [2] = LAYOUT_60_ansi(
        ...
        _______, RGB_TOG, _______, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_MOD, RGB_M_P, RGB_RMOD, RGB_MOD, RESET,
